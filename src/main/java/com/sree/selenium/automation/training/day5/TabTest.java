...
public class TabTest extends BaseFireBase{
	...
	//	System.out.println(driver.getWindowHandles());
		...
		Thread.sleep(4000);
		WebElement windowButtonEle = driver.findElement(By.xpath("//button[contains(text(),'Tab')]"));
		clickElement(windowButtonEle, "Tab Button");
